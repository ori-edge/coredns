...
func (e *Ingress) serveApex(state request.Request) (int, error) {
	m := new(dns.Msg)
...
func (e *Ingress) serveSubApex(state request.Request) (int, error) {
...
func (e *Ingress) soa(state request.Request) *dns.SOA {
...
func (e *Ingress) ns(state request.Request) *dns.NS {
